...
class Book(models.Model):
    ...
    book_auth = models.CharField(
        max_length=100, help_text='Book author', null=True)
...
class Movie(models.Model):
    ...
    Director = models.CharField(
        max_length=100, help_text="Director Name", null=True)
    Producer = models.CharField(
        max_length=100, help_text="Producer Name", null=True)
    mychoice = (('1', 'one'),
                ('2', 'Two'),
                ('3', 'Three'))
    ...
    Awards = models.CharField(
        max_length=2, help_text="Awards won", choices=mychoice, default=1)
    Category = models.CharField(
        max_length=2, help_text="Movie Category", choices=typechoice, default=5)
...
class Novel(models.Model):
    ...
    novel_name = models.CharField(
        max_length=100, help_text='Novel Name', null=True)
    purchase_date = models.DateField(null=True, blank=True)
    genre = models.ManyToManyField('Genre', help_text='genre of Novel')
    author = models.ForeignKey(
        'Author', on_delete=models.SET_NULL, help_text='Novel Author', null=True)
...
class Author(models.Model):
    author_name = models.CharField(
        max_length=100, help_text='Name of Author', null=True)
    numChoice = (
        ('1', 'One'),
        ('2', 'Two'),
        ('3', 'Three'),
...
class library(models.Model):
    Studentname = models.CharField(
        max_length=100, help_text='Student Name', null=True)
